...
import { MLNodeData } from '../config/nodeRegistry'; // <-- THIS MUST BE nodeRegistry, NOT nodeCatalog
...
// Exported for Node Studio to use
...
export function useCodeGenerator(): string {
  ...
  nodes.forEach((node) => {
    ...
    // Auto-add imports based on node type (Updated to use 'title')
